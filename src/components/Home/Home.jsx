                        ...
                        <div className={"row"}>
                            <div className={"col-12 col-md-6 "}>
                                <div className={" d-flex"}>
                                    <p className={"d-flex align-items-center gap-1"}><span className={css.barrinha + " d-inline-block"}></span><span>Novidade</span></p>
                                </div>
                                <div>
                                    <h2 className={"fw-bold " + css.h2}>Destaque da Semana</h2>
                                </div>
                            </div>
                            <div className={"col-12 col-md-6 " + css.filtro}>
                                <select className={"p-2 rounded-5 "}>
                                    <option>Ordenar mais: Relevânte</option>
